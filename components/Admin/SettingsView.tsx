...
const SettingsView: React.FC = () => {
  ...
  const sqlSchema = `-- RUN THIS IN YOUR POSTGRESQL DATABASE
           ...
           <div className="bg-blue-600 p-8 md:p-10 rounded-[48px] text-white shadow-xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-blue-100 text-sm mb-8 leading-relaxed">
                  PostgreSQL requires tables to be created before use. Copy the SQL below and run it in your PostgreSQL database to initialize the project.
                </p>
      ...
      {showPurgeConfirm && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md z-[200] flex items-center justify-center p-6 animate-in fade-in duration-200">
          <div className="bg-white rounded-[40px] shadow-2xl w-full max-w-sm p-10 text-center">
            ...
            <p className="text-slate-500 text-sm mb-8 leading-relaxed">This clears your local session and local storage. Server database remains untouched.</p>
