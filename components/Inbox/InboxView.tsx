...
const ChatWindow: React.FC<ChatWindowProps> = ({ conversation, onDelete }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-white dark:bg-slate-900 relative overflow-hidden">
      ...
      <div className="px-4 md:px-8 py-4 md:py-5 border-b border-slate-100 dark:border-slate-700 flex items-center justify-between bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shrink-0 z-30">
        <div className="flex items-center gap-3 md:gap-4 ml-10 md:ml-0 flex-1 min-w-0">
          <div className="relative flex-shrink-0">
            ...
            <div className={`absolute -bottom-1 -right-1 w-3.5 h-3.5 ${socketConnected ? 'bg-green-500' : 'bg-amber-400'} border-2 border-white dark:border-slate-800 rounded-full`}></div>
          </div>
      ...
      <div className="p-4 md:p-8 border-t border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-900 shrink-0">
        <div className="flex items-end gap-2 md:gap-3 w-full">
           ...
           <div className="flex-1 relative min-w-0">
             <textarea
               ...
               className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl md:rounded-3xl p-3 md:p-4 text-sm md:text-base outline-none focus:ring-4 focus:ring-blue-50 dark:focus:ring-blue-900/30 focus:border-blue-200 dark:focus:border-blue-500 transition-all resize-none min-h-[56px] max-h-[120px] custom-scrollbar dark:text-slate-200"
