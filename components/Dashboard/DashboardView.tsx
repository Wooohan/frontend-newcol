...
const DashboardView: React.FC = () => {
  ...
  const stats = [
    ...
    { label: 'Server Ping', value: "24ms", icon: Clock, color: 'text-purple-600', bg: 'bg-purple-50' },
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-1">
            <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full border text-[10px] font-black uppercase tracking-widest transition-colors duration-500 ${
              ...
              Provider: PostgreSQL {dbStatus.toUpperCase()}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-slate-900 p-12 rounded-[56px] text-white shadow-2xl relative overflow-hidden group">
           ...
           <div className="flex flex-col h-full relative z-10">
             ...
             <h3 className="text-3xl font-black mb-4 tracking-tight">Server Security</h3>
             <p className="text-slate-400 text-base leading-relaxed mb-12">PostgreSQL engine is active. The portal uses REST + WebSocket for realtime messaging with zero polling overhead.</p>
